        ...
        ZStack(alignment: .topLeading) {
            ...
            .alignmentGuide(.leading) { dimensions in
                ...
                return MainActor.assumeIsolated {
                    ...
                    case .fill:
                        let activeLineSpan = resolvedLineSpan()
                        currentLineSpan = activeLineSpan
                        
                        currentIndex = alignments
                            .enumerated()
                            .map { enumerated -> (element: CGFloat, offset: Int) in
                                let element = (0..<activeLineSpan).reduce(enumerated.element) { alignment, span in
                    ...
                    case .order:
                        ...
                        currentLineSpan = resolvedLineSpan()
